...
while auxiliar is True:
    ...
    if idioma[0] == 'N':  # SELECIONA OPÇÃO EM PORTUGUÊS
        ...
        while op != 0:
            ...
            print('Informe o documento cadastrado em seu checkin: ')
            voucher = input('')
            funcoes.limpa()
            if voucher == '000':
                opt = 1
                    ...
                    if opt == 1:  # ENCONTRAR PONTOS TURÍSTICOS
                            ...
                            if (pt[0]).upper() == 'S':
                                ...
                                while aux_ponto:
                                    ...
                                    if len(ponto_local) < 1:
                                        ...
                                        print(
                                            'Gostaria de um arquivo sobre esse ponto?')
                                        arq = input(
                                            '(S - Sim/N - Não)').upper()
                                        if arq[0] == 'S':
                                            ...
                                            print(
                                                'Gostaria de procurar outro ponto?')
                                            novo = input(
                                                '(S - Sim/N - Não)').upper()
                                            if novo[0] == 'S':
                                                funcoes.limpa()
                        ...
                        while hotel != 0:
                            ...
                            if av[0] == 'S':
                                ...
                                arquivo = open(
                                    'comentario_hotel.txt', 'a', encoding='utf-8')
                        ...
                        if av[0] == 'S':
                            coment = input('Informe aqui seu comentário: ')
                            arquivo = open(
                                'comentario_eventum.txt', 'a', encoding='utf-8')
                            arquivo.write(coment+"\n")
                            arquivo.close()
                        print('Obrigado pela sua avaliação!')
                        funcoes.pausa_pt()
        ...
        opt = 1
        while opt != 0:
            print('Informar el documento registrado en su checkin: ')
            voucher = input('')
            funcoes.limpa()
            if voucher == '000':
                ...
                if opt == 1:  # ENCONTRAR PONTOS TURÍSTICOS
                    ...
                    while hotel != 0:
                        ...
                        if hotel == 1:
                            ...
                            funcoes.limpa()
                        print(
                            f'Responder preguntas sobre el hotel {hosped}.\n')
                        soma = 0.0
                        i = 0
                        while i in range(len(v)):
                            print(v[i])
                    ...
                    while i in range(len(v)):
                        print(v[i])
                        a = float(
                            input('Introduzca una puntuación de 0 a 10: '))
                        if a > 10 or a < 0:
                            print('Esta nota no se puede ingresar.')
                            i = i - 1
                        else:
